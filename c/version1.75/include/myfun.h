...
void DrawLimitLines(void);

void DrawTimer(void);

void DrawMenu(void);

void DisplayModeButtons(void);

void ShowModeState(void);
...
void SaveCurrentData(char* name, Triangle* t, Rectangle* r, int ST, int Mode);

void ReadSavedData(char* name, Triangle* t, Rectangle* r, int* ST, int* Mode);
